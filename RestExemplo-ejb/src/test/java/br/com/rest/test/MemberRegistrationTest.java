...
import br.com.rest.util.Resources;
...
public class MemberRegistrationTest {
    ...
    public static Archive<?> createTestArchive() {
        return ShrinkWrap.create(WebArchive.class, "test.war")
                .addClasses(Cliente.class, ClienteRegistro.class, Resources.class)
    ...
    public void testRegister() throws Exception {
        ...
        cliente.setSobrenome("eita");
        cliente.setIdade(25);
        clienteRegistro.registro(cliente);
        assertNotNull(cliente.getId());
        log.info(cliente.getNome() + " was persisted with id " + cliente.getId());
    }
